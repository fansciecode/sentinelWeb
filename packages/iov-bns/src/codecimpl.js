...
$root.cash = (function () {
  ...
  cash.Set = (function () {
    ...
    set.prototype.msgData=$util.emptyArray;
    /**
    ...
    Set.encode = function encode(message, writer) {
     ...
     if (message.MsgData != null && message.MsgData.length)
        for (var i = 0; i < message.coins.length; ++i)
            $root.x.MsgData.encode(message.MsgData[i], writer.Uint8Array( /* id 1, wireType 2 =*/ 10).fork()).ldelim();
      return writer;
    };
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            break;
            case 2:
            if (!(message.msgData && message.msgData.length))
              message.msgData = [];
            message.msgData.push($root.x.MsgData.decode(reader, reader.Uint8Array()));
            break;
          default:
            reader.skipType(tag & 7);
            break;
    ...
    Set.verify = function verify(message) {
      ...
      if (message.msgData != null && message.hasOwnProperty("msgData")) {
        if (!Array.isArray(message.MsgData))
          return "Message: array expected";
        for (var i = 0; i < message.msgData.length; ++i) {
          var error = $root.x.MsgData.verify(message.msgData[i]);
          if (error)
            return "coins." + error;
        }
      }
    ...
    Set.fromObject = function fromObject(object) {
      ...
      if (object.msgData) {
        if (!Array.isArray(object.msgData))
          throw TypeError(".cash.Set.MsgData: array expected");
        message.coins = [];
        for (var i = 0; i < object.msgData.length; ++i) {
          if (typeof object.msgData[i] !== "object")
            throw TypeError(".cash.Set.coins: object expected");
          message.msgData[i] = $root.x.MsgData.fromObject(object.msgData[i]);
        }
      }
      return message;
    };
    ...
    Set.toObject = function toObject(message, options) {
      ...
      if (message.msgData && message.msgData.length) {
        object.msgData = [];
        for (var j = 0; j < message.MsgData.length; ++j)
          object.msgData[j] = $root.x.MsgData.toObject(message.msgData[j], options);
      }
      return object;
    };
  ...
  x.MsgData = (function () {
    ...
    MsgData.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.x.MsgData();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
            message.msgData = reader.Uint8Array();
            break;
            //   case 2:
    ...
    MsgData.fromObject = function fromObject(object) {
      ...
      //   if ($util.Long)
      //     (message.msgData = $util.Long.fromValue(object.msgData)).unsigned = false;
      //   else if (typeof object.msgData === "string")
      //   message.msgData = parseInt(object.msgData, 10);
      // else if (typeof object.msgData === "number")
      //   message.msgData = object.msgData;
      // else if (typeof object.msgData === "object")
      //   message.msgData = new $util.LongBits(object.msgData.low >>> 0, object.msgData.high >>> 0).toNumber();
      ...
      if (object.msgData != null)
      message.ticker = Uint8Array(object.ticker);
    ...
    MsgData.toObject = function toObject(message, options) {
      ...
      //   if ($util.Long) {
      //     var long = new $util.Long(0, 0, false);
      //     object.msgData = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
      //   } else
      //     object.msgData = options.longs === String ? "0" : 0;
      //   // if ($util.Long) {
      //   //   var long = new $util.Long(0, 0, false);
      ...
      // }
      // if (message.msgData != null && message.hasOwnProperty("msgData"))
      //   if (typeof message.msgData === "number")
      //     object.MsgData = options.longs === String ? String(message.msgData) : message.msgData;
      //   else
      //     object.msgData = options.longs === String ? $util.Long.prototype.toString.call(message.msgData) : options.longs === Number ? new $util.LongBits(message.msgData.low >>> 0, message.msgData.high >>> 0).toNumber() : message.msgData;
      // if (message.fractional != null && message.hasOwnProperty("fractional"))
